...
void display()
{
	...
	for (int i = 0; i < NUMBER_OF_SPHERES; i++)
	{
		...
		{
		case 1:
			modelMatrix = translate(-2.5f, 3.3f, -10.0f);
			glViewport(-650, 1, (GLsizei)2000, (GLsizei)WIN_HEIGHT);

		break;
		case 2:
			modelMatrix = translate(-2.5f, 2.0f, -10.0f);
			glViewport(-650, -2.5, (GLsizei)2000, (GLsizei)WIN_HEIGHT);
		break;
		case 3:
			modelMatrix = translate(-2.5f, 0.5f, -10.0f);
			glViewport(-650, -2.9, (GLsizei)2000, (GLsizei)WIN_HEIGHT);
		break;
		case 4:
			modelMatrix = translate(-2.5f, -1.0f, -10.0f);
			glViewport(-650, -3.2, (GLsizei)2000, (GLsizei)WIN_HEIGHT);
		break;
		case 5:
		...
		case 6:
			...
			glViewport(-650, -3.2, (GLsizei)1990, (GLsizei)WIN_HEIGHT);
			break;

		case 7:
			modelMatrix = translate(-1.0f, 3.3f, -10.0f);
			glViewport(-350, 1, (GLsizei)2000, (GLsizei)WIN_HEIGHT);
			break;
		case 8:
			modelMatrix = translate(-1.0f, 2.0f, -10.0f);
			glViewport(-350, -2.9, (GLsizei)2000, (GLsizei)WIN_HEIGHT);
			break;
		case 9:
			modelMatrix = translate(-1.0f, 0.5f, -10.0f);
			glViewport(-350, -3.2, (GLsizei)2000, (GLsizei)WIN_HEIGHT);
		...
		case 13:
			modelMatrix = translate(1.0f, 3.3f, -10.0f);
			glViewport(-100, 1, (GLsizei)2000, (GLsizei)WIN_HEIGHT);
			break;
		case 14:
			modelMatrix = translate(1.0f, 2.0f, -10.0f);
			glViewport(-100, -2.5, (GLsizei)2000, (GLsizei)WIN_HEIGHT);
			break;
		case 15:
			modelMatrix = translate(1.0f, 0.5f, -10.0f);
			glViewport(-100, -2.9, (GLsizei)2000, (GLsizei)WIN_HEIGHT);
			break;
		case 16:
			modelMatrix = translate(1.0f, -1.0f, -10.0f);
			glViewport(-100, -3.2, (GLsizei)2000, (GLsizei)WIN_HEIGHT);
			break;
		case 17:
			modelMatrix = translate(1.0f, -2.5f, -10.0f);
			glViewport(-100, -3.2, (GLsizei)2000, (GLsizei)WIN_HEIGHT);
		...
		case 19:
			...
			glViewport(250, 1, (GLsizei)2000, (GLsizei)WIN_HEIGHT);
			break;
		case 20:
			modelMatrix = translate(2.0f, 2.0f, -10.0f);
			glViewport(250, -2.5, (GLsizei)2000, (GLsizei)WIN_HEIGHT);
			break;
		case 21:
			modelMatrix = translate(2.0f, 0.5f, -10.0f);
			glViewport(250, -2.9, (GLsizei)2000, (GLsizei)WIN_HEIGHT);
			break;
		case 22:
			modelMatrix = translate(2.0f, -1.0f, -10.0f);
			glViewport(250, -3.2, (GLsizei)2000, (GLsizei)WIN_HEIGHT);
			break;
		case 23:
		...
		case 24:
			...
			glViewport(250, -8.2, (GLsizei)2000, (GLsizei)WIN_HEIGHT);
			break;
