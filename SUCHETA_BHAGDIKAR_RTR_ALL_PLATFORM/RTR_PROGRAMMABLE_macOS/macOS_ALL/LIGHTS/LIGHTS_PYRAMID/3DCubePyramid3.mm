...
-(void)applicationDidFinishLaunching:(NSNotification *)aNotification
{
  ...
  fprintf(gpFile, "Program Is Started Successfully\n");
	...
	[window setTitle:@"macOS Pyramid Two Lights"];
	[window center];
...
-(void)prepareOpenGL
{
    ...
    La_uniform = glGetUniformLocation(shaderProgramObject, "u_LaBlue");
    //diffuse color intensity of LIGHT
    Ld_uniform = glGetUniformLocation(shaderProgramObject, "u_LdBlue");
    //specular color intensity of LIGHT
    Ls_uniform = glGetUniformLocation(shaderProgramObject, "u_LsBlue");
    //position of light
    light_position_uniform = glGetUniformLocation(shaderProgramObject, "u_light_positionBlue");
    
    //ambient reflective color intensity of MATERIAL
    Ka_uniform = glGetUniformLocation(shaderProgramObject, "u_KaBlue");
    //diffuse reflective color intensity of MATERIAL
    Kd_uniform = glGetUniformLocation(shaderProgramObject, "u_KdBlue");
    //specular reflective color intensity of MATERIAL
    Ks_uniform = glGetUniformLocation(shaderProgramObject, "u_KsBlue");
...
-(void)drawView
{
    ...
    {        //set u_lighting_enabled uniform
        ...
        glUniform3fv(La_uniform, 1, light_ambient2);
        glUniform3fv(Ld_uniform, 1, lightDiffuse2);
        glUniform3fv(Ls_uniform, 1, lightSpecular2);
        glUniform4fv(light_position_uniform, 1, lightPosition2);
        ...
        glUniform1f(material_shininess_uniformRed, material_shininess);
          ...
          glUniform1i(L_KeyPressed_uniformRed, 0);
    }
