...
// void dealloc();
   ...
   szInfoLog = NULL;
    ...
    model_matrix_uniform2 = glGetUniformLocation(shaderProgramObject, "u_model_matrix2");
    view_matrix_uniform2 = glGetUniformLocation(shaderProgramObject, "u_view_matrix2");
    projection_matrix_uniform2 = glGetUniformLocation(shaderProgramObject, "u_projection_matrix2");
