...
-(void)applicationDidFinishLaunching:(NSNotification *)aNotification
{
  ...
  fprintf(gpFile, "Program Is Started Successfully\n");
	...
	[window setTitle:@"macOS Three Lights Fragment OpenGL Window"];
	[window center];
...
-(void)drawView
{
    ...
    if (gbLight == true)
    {
        ...
        //setting material's properties
        glUniform3fv(Ks_uniformGreen, 1, material_ambient);
        ...
        //setting material's properties
        glUniform3fv(Ks_uniformBlue, 1, material_ambient);
