...
-(void) perVertex
{
   ...
   "vec3 light_directionBlue = normalize(vec3(u_light_positionBlue) - eye_coordinates.xyz);"\
    ...
    //ambient color intensity of LIGHT
    La_uniform2 = glGetUniformLocation(shaderProgramObject, "u_LaGreen");
    //diffuse color intensity of LIGHT
    Ld_uniform2 = glGetUniformLocation(shaderProgramObject, "u_LdGreen");
    //specular color intensity of LIGHT
    Ls_uniform2 = glGetUniformLocation(shaderProgramObject, "u_LsGreen");
    //position of light
    light_position_uniform2 = glGetUniformLocation(shaderProgramObject, "u_light_positionGreen");
    
    //ambient reflective color intensity of MATERIAL
    Ka_uniform2 = glGetUniformLocation(shaderProgramObject, "u_KaGreen");
    //diffuse reflective color intensity of MATERIAL
    Kd_uniform2 = glGetUniformLocation(shaderProgramObject, "u_KdGreen");
    
    //specular reflective color intensity of MATERIALc
    Ks_uniform2 = glGetUniformLocation(shaderProgramObject, "u_KsGreen");
    
    
    //shininess of material (value is conventionally between 1 to 200)
    La_uniform3 = glGetUniformLocation(shaderProgramObject, "u_LaBlue");
    //diffuse color intensity of LIGHT
    Ld_uniform3 = glGetUniformLocation(shaderProgramObject, "u_LdBlue");
    //specular color intensity of LIGHT
    Ls_uniform3 = glGetUniformLocation(shaderProgramObject, "u_LsBlue");
    //position of light
    light_position_uniform3 = glGetUniformLocation(shaderProgramObject, "u_light_positionBlue");
    
    //ambient reflective color intensity of MATERIAL
    Ka_uniform3 = glGetUniformLocation(shaderProgramObject, "u_KaBlue");
    //diffuse reflective color intensity of MATERIAL
    Kd_uniform3 = glGetUniformLocation(shaderProgramObject, "u_KdBlue");
    
    //specular reflective color intensity of MATERIALc
    Ks_uniform3 = glGetUniformLocation(shaderProgramObject, "u_KsBlue");
...
-(void) perFragment
{
    ...
    //L/I Key is pressed or not
    F_KeyPressed_uniform2 = glGetUniformLocation(shaderProgramObject, "u_lighting_enabled2");
    
    //ambient color intensity of LIGHT
    La_uniform4 = glGetUniformLocation(shaderProgramObject, "u_La");
    //diffuse color intensity of LIGHT
    Ld_uniform4 = glGetUniformLocation(shaderProgramObject, "u_Ld");
    //specular color intensity of LIGHT
    Ls_uniform4 = glGetUniformLocation(shaderProgramObject, "u_Ls");
    //position of light
    light_position_uniform4 = glGetUniformLocation(shaderProgramObject, "u_light_position");
    
    //ambient reflective color intensity of MATERIAL
    Ka_uniform4 = glGetUniformLocation(shaderProgramObject, "u_Ka");
    //diffuse reflective color intensity of MATERIAL
    Kd_uniform4 = glGetUniformLocation(shaderProgramObject, "u_Kd");
    
    //specular reflective color intensity of MATERIALc
    Ks_uniform4 = glGetUniformLocation(shaderProgramObject, "u_Ks");
    
    //shininess of material (value is conventionally between 1 to 200)
    material_shininess_uniform4 = glGetUniformLocation(shaderProgramObject, "u_material_shininess");
...
-(void)drawView
{
    ...
    lightDiffuse4[0] = 1.0f;
    lightDiffuse4[1] = 1.0f;
    lightDiffuse4[2] = 1.0f;
    lightDiffuse4[3] = 1.0f;
    
    lightPosition4[0] = 100.0f;
    lightPosition4[1] = 100.0f;
    lightPosition4[2] = 100.0f;
    lightPosition4[3] = 1.0f;
    
    lightSpecular4[0] = 1.0f;
    lightSpecular4[1] = 1.0f;
    lightSpecular4[2] = 1.0f;
    lightSpecular4[3] = 1.0f;
    
    material_ambient4[0] = 0.0f;
    material_ambient4[1] = 0.0f;
    material_ambient4[2] = 0.0f;
    material_ambient4[3] = 1.0f;
    
    material_diffuse4[0] = 1.0f;
    material_diffuse4[1] = 1.0f;
    material_diffuse4[2] = 1.0f;
    material_diffuse4[3] = 1.0f;
    
    material_specular4[0] = 1.0f;
    material_specular4[1] = 1.0f;
    material_specular4[2] = 1.0f;
    material_specular4[3] = 1.0f;
    
    material_shininess4 = 50.0f;
    ...
    if (gbLight == true)
    {
      ...
      glUniform1f(material_shininess_uniform, material_shininess);
        ...
        glUniform4fv(light_position_uniform2, 1, myArrGreen);
        
        //setting material's properties
        glUniform3fv(Ka_uniform2, 1, material_ambient);
        glUniform3fv(Kd_uniform2, 1, material_diffuse);
        glUniform3fv(Ks_uniform2, 1, material_specular);
        glUniform1f(material_shininess_uniform, material_shininess);
        ...
        glUniform4fv(light_position_uniform3, 1, myArrBlue);
   ...
   if (gbLight2 == true)
    {
      ...
      viewMatrix = vmath::mat4::identity();
        ...
        glUniform1i(F_KeyPressed_uniform2, 1);
        ...
        glUniform4fv(light_position_uniform4, 1, lightPosition4);
        
        //setting material's properties
        glUniform3fv(Ka_uniform4, 1, material_ambient4);
        glUniform3fv(Kd_uniform4, 1, material_diffuse4);
        glUniform3fv(Ks_uniform4, 1, material_specular4);
    ...
    modelMatrix = vmath::translate(0.0f, 0.0f, -3.5f);
...
-(void)keyDown:(NSEvent *)theEvent
{
    ...
    switch(key)
    {
        ...
        case 'f':
        case 'F':
			 if(gbFKeyIsPressed2 == false)
            {
                gbLight2 = true;
                gbFKeyIsPressed2 = true;
            }
            else
            {
                gbLight2 = false;
                gbFKeyIsPressed2 = false;
            }
            break;
			break;
        default:
