...
-(void)applicationDidFinishLaunching:(NSNotification *)aNotification
{
  ...
  fprintf(gpFile, "Program Is Started Successfully\n");
	...
	[window setTitle:@"macOS 24 Spheres Materials OpenGL Window"];
	[window center];
...
-(void)reshape
{
 ...
 //  GLfloat width1 = rect.size.width1;
 //   GLfloat height1 = rect.size.height1;
    rect = [self bounds];
...
-(void)drawView
{
 ...
 //   NSRect rect = [self bounds];
  ...
  //  GLfloat height = rect.size.height;
    ...
    [self drawSphere];
  glViewport(0,width / 6.8,(GLsizei)width/6,(GLsizei)height/6);
    ...
    /////////////////// SPHERE 8
     ...
     [self drawSphere];
     glViewport(width / 5.8,width / 6.8,(GLsizei)width/6,(GLsizei)height/6);
    ...
    /////////////////// SPHERE 9
    [self drawSphere];
    glViewport(width / 3,width / 6.8,(GLsizei)width/6,(GLsizei)height/6);
    ...
    /////////////////// SPHERE 10
    [self drawSphere];
    glViewport(width / 2,width / 6.8,(GLsizei)width/6,(GLsizei)height/6);
    ...
    /////////////////// SPHERE 11
    [self drawSphere];
    glViewport(width / 1.5,width / 6.8,(GLsizei)width/6,(GLsizei)height/6);
    ...
    /////////////////// SPHERE 12
    [self drawSphere];
    glViewport(width / 1.2,width / 6.8,(GLsizei)width/6,(GLsizei)height/6);
    ...
    [self drawSphere];
    glViewport(0,height / 2,(GLsizei)width/6,(GLsizei)height/6);
    ...
    /////////////////// SPHERE 14
    [self drawSphere];
    glViewport(width / 5.8,height /2,(GLsizei)width/6,(GLsizei)height/6);
    ...
    /////////////////// SPHERE 15
    [self drawSphere];
    glViewport(width / 3,height / 2,(GLsizei)width/6,(GLsizei)height/6);
    ...
    /////////////////// SPHERE 16
    [self drawSphere];
    glViewport(width /2,height / 2,(GLsizei)width/6,(GLsizei)height/6);
    ...
    /////////////////// SPHERE 17
    [self drawSphere];
    glViewport(width / 1.5,height / 2,(GLsizei)width/6,(GLsizei)height/6);
    ...
    /////////////////// SPHERE 18
    [self drawSphere];
    glViewport(width / 1.2,height / 2,(GLsizei)width/6,(GLsizei)height/6);
    ...
    /////////////////// SPHERE 19
    [self drawSphere];
    glViewport(0,height / 1.3,(GLsizei)width/6,(GLsizei)height/6);
    ...
    /////////////////// SPHERE 20
    [self drawSphere];
    glViewport(width / 5.8,height / 1.3,(GLsizei)width/6,(GLsizei)height/6);
    ...
    /////////////////// SPHERE 21
    [self drawSphere];
    glViewport(width / 3.0,height / 1.3,(GLsizei)width/6,(GLsizei)height/6);
    glUniform3fv(Ka_uniform, 1, material_ambient21);
    glUniform3fv(Kd_uniform, 1, material_specular21);
    glUniform3fv(Ks_uniform, 1, material_diffuse21);    
    /////////////////// SPHERE 22
    [self drawSphere];
    glViewport(width / 2.0,height / 1.3,(GLsizei)width/6,(GLsizei)height/6);
    ...
    /////////////////// SPHERE 23
    [self drawSphere];
    glViewport(width / 1.5,height / 1.3,(GLsizei)width/6,(GLsizei)height/6);
    ...
    /////////////////// SPHERE 24
    [self drawSphere];
    glViewport(width / 1.2,height / 1.3,(GLsizei)width/6,(GLsizei)height/6);
    ...
    if (gbRotateX == true)
    {
        myArrX[1] = lightPosition[0] * (sin(angleRadianX));
        myArrX[2] = lightPosition[0] * (cos(angleRadianX));
    }
    else if (gbRotateY == true)
    {
        myArrY[0] = lightPosition[1] * (sin(angleRadianY));
        myArrY[2] = lightPosition[1] * (cos(angleRadianY));
    }
    else if (gbRotateZ == true)
    {
        myArrZ[0] = lightPosition[2] * (sin(angleRadianZ));
        myArrZ[1] = lightPosition[2] * (cos(angleRadianZ));
    }
    glUseProgram(0);
