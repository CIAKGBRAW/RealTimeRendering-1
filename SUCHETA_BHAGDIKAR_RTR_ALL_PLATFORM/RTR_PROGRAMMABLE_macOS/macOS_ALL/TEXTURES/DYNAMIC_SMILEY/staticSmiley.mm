...
@implementation GLView
{
    ...
    GLuint vao_WhiteQuad;
    GLuint vbo_Pos_White;
    GLuint vbo_Tex_White;
    GLuint texname;
...
-(void)prepareOpenGL
{
    ...
    //VAO WHITE QUAD
    /////////////////////////
    glGenVertexArrays(1, &vao_WhiteQuad);
    glBindVertexArray(vao_WhiteQuad);
    //vbo white texcoords
    
    glGenBuffers(1, &vbo_Tex_White);
    glBindBuffer(GL_ARRAY_BUFFER, vbo_Tex_White);
    ...
    glGenBuffers(1, &vbo_Pos_White);
    glBindBuffer(GL_ARRAY_BUFFER, vbo_Pos_White);
    
    glBufferData(GL_ARRAY_BUFFER, sizeof(smileyCoords1), smileyCoords1, GL_STATIC_DRAW);
    glVertexAttribPointer(VDG_ATTRIBUTE_VERTEX, 3, GL_FLOAT, GL_FALSE, 0, NULL);
    glEnableVertexAttribArray(VDG_ATTRIBUTE_VERTEX);
    glBindBuffer(GL_ARRAY_BUFFER, 0);
    glBindVertexArray(0);
