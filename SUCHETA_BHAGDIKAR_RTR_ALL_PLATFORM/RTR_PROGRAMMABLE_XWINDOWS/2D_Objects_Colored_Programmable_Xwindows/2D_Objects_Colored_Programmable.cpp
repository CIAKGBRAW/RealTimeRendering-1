...
//	char * szInfoLog = NULL;
	...
	glBindBuffer(GL_ARRAY_BUFFER,gVbo_Position_Triangle);		//start vbo position triangle
	...
	glBindBuffer(GL_ARRAY_BUFFER,gVbo_Color_Triangle);		//start vbo color triangle
	...
	glGenBuffers(1,&gVbo_Position_Square);			//start vbo square position
	...
	glBindBuffer(GL_ARRAY_BUFFER,0);			//end vbo square position
...
{	
	...
	{
		glDeleteBuffers(1,&gVbo_Position_Square);
		gVbo_Position_Square = 0;
	}
	
	if(gVbo_Color_Square)
	{
		glDeleteBuffers(1,&gVbo_Color_Square);
		gVbo_Color_Square = 0;
	}
